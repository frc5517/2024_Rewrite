...
public class SwerveSubsystem extends SubsystemBase {
    ...
    public SwerveSubsystem(SwerveDriveConfiguration driveCfg, SwerveControllerConfiguration controllerCfg) {
        swerveDrive = new SwerveDrive(driveCfg, controllerCfg, Constants.SwerveConstants.maxSpeed);
    }
...
// Since AutoBuilder is configured, we can use it to build pathfinding commands
    ...
    public Command customDriveCommand(boolean fieldRelative, DoubleSupplier translationX, DoubleSupplier translationY, DoubleSupplier angularRotationX
        ...
        return run(() -> {
            ...
            else if (highSpeed.getAsBoolean()) {
                maxSpeed = SwerveConstants.highSpeedMultiple;
            } // If highSpeed held go fast.
            else {
